    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-2xl border border-white/20 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
            <h3 className="text-lg font-medium text-red-300 flex items-center space-x-2">
              <span className="text-red-400 animate-spin" style={{ animation: 'spin 2s linear infinite' }}>🚨</span>
              <span>Allows shocks past limit</span>
            </h3>
            <p className="text-sm text-red-200">
              Enable this to allow others to shock you past your configured limits. This setting can be toggled from the header.
            </p>
            <div className="p-3 bg-black/20 rounded border border-gray-600">
              <p className="text-xs text-gray-400">
                Note: This setting is now available in the header next to the "PiShock Controller" title. You can toggle it there for easier access.
              </p>
            </div>
          </div>
        </div>
