...
export function ControllerPlusPurchaseModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-purple-900/90 via-blue-900/90 to-indigo-900/90 backdrop-blur-sm rounded-2xl border border-purple-500/30 max-w-lg w-full shadow-2xl">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Pricing */}
          <div className="bg-gradient-to-r from-purple-900/40 to-blue-900/40 border border-purple-500/30 rounded-xl p-4">
            <div className="text-center">
        ...
        <div className="flex items-center justify-between p-6 border-t border-purple-500/20">
          ...
          <button
            onClick={onPurchase}
            className="px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-lg font-semibold flex items-center space-x-2 transition-all shadow-lg"
          >
