...
export function UserSelector({ 
  ...
  return (
    <div className="h-full ps-panel-shell rounded-md p-4 flex flex-col">
          ...
          {members.length === 0 ? (
            ...
            <>
                ...
                return (
                  <div className="mb-4">
                    ...
                    <button
                      ...
                      disabled={isDisabled}
                      className={`w-full p-2 sm:p-3 rounded-md border transition-all text-left ${
                        isDisabled
                          ...
                          : 'bg-slate-900/40 border-cyan-500/35 hover:bg-slate-900/70 hover:border-cyan-300/50'
                      }`}
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center space-x-2 sm:space-x-3">
                            ...
                            />
                            <div className="min-w-0 flex-1">
                              <p className="font-medium text-cyan-100 text-xs sm:text-sm truncate">
              ...
              {otherParticipants.length > 0 && otherParticipants.every(member => !userPiShockStatus[member.id]?.isConnected) && (
                <div className="mt-4 p-3 bg-yellow-950/20 border border-yellow-500/35 rounded-md">
      ...
      {selectedUser && (
        <div className="mt-4 p-2 sm:p-3 bg-emerald-950/20 border border-emerald-500/35 rounded-md flex-shrink-0">
