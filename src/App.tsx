...
function MainApp() {
  ...
  if (isDirectVisit) {
    return (
      <div className="min-h-screen ps-app-shell text-white flex items-center justify-center p-4">
  ...
  if (loading) {
    return (
      <div className="h-screen w-screen ps-app-shell flex items-center justify-center overflow-hidden">
        <div className="text-center">
          <div className="ps-loading-ring mx-auto mb-4"></div>
          <p className="text-white text-sm tracking-wide uppercase">Connecting to Discord...</p>
          {instanceId && (
            <p className="ps-muted-text text-xs mt-2">Instance: {instanceId}</p>
          )}
        </div>
      </div>
    );
  ...
  if (!isInstanceValid) {
    return (
      <div className="h-screen w-screen ps-app-shell text-white overflow-hidden flex items-center justify-center">
        <div className="text-center max-w-md p-8 ps-panel-shell rounded-lg">
          <div className="w-16 h-16 mx-auto mb-6 bg-red-500/20 rounded-md flex items-center justify-center border border-red-500/30">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-6 ps-btn-compact ps-btn-compact-warn rounded-md font-semibold transition-colors"
            >
              Close Session
            </button>
      ...
      <div className="h-screen w-screen ps-app-shell text-white overflow-hidden flex items-center justify-center">
        ...
        <div className="w-full h-full max-w-sm mx-auto p-4 flex flex-col">
          <div className="text-center mb-4 flex-shrink-0">
            <div className="w-12 h-12 mx-auto rounded-md border border-cyan-400/40 bg-cyan-500/10 flex items-center justify-center mb-2">
          ...
          {participants.length > 1 && (
            <div className="mt-4 flex-shrink-0">
              <select
                ...
                className="w-full px-3 py-2 bg-slate-950 border border-cyan-500/40 rounded-md text-sm focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent"
              >
  ...
  return (
    <div className="h-screen w-screen ps-app-shell text-white overflow-hidden flex flex-col">
      <NotificationSystem 
        notifications={notifications} 
        onDismiss={dismissNotification} 
      />
            ...
            <div className="flex items-center space-x-4">
              ...
              {isAdminUser && (
                <button
                  ...
                  className="ps-btn-compact text-xs transition-colors flex items-center space-x-1 border-amber-500/60 text-amber-200"
